...
const translations = {
    uk: {
        ...
        'about.text1': 'Я, ФОП Балацька Валентина Іванівна, надаю професійні послуги з психології та нумерології. Проводжу онлайн консультації за допомогою застосунку ZOOM, вебінари, семінари, групові та індивідуальні навчання з нумерології, символізму та психології.',
        'about.text2': 'Я дипломований психолог з вищою освітою за спеціальністю «Практичний психолог» Інституту післядипломної освіти ім. Тараса Шевченка. Моя мета - допомогти вам знайти внутрішню гармонію, розібратися з життєвими викликами та розкрити свій потенціал.',
    ...
    en: {
        ...
        'about.text1': 'I, FOP Balatska Valentyna Ivanivna, provide professional services in psychology and numerology. I conduct online consultations via ZOOM, webinars, seminars, group and individual training in numerology, symbolism, and psychology.',
        'about.text2': 'I am a certified psychologist with higher education in "Practical Psychology" from the Taras Shevchenko Institute of Postgraduate Education. My goal is to help you find inner harmony, deal with life challenges, and unlock your potential.',
    ...
    ru: {
        ...
        // About
        'about.title': 'Обо мне',
        'about.text1': 'Я, ФОП Балацкая Валентина Ивановна, предоставляю профессиональные услуги по психологии и нумерологии. Провожу онлайн консультации с помощью приложения ZOOM, вебинары, семинары, групповое и индивидуальное обучение по нумерологии, символизму и психологии.',
        'about.text2': 'Я дипломированный психолог с высшим образованием по специальности «Практический психолог» Института последипломного образования им. Тараса Шевченко. Моя цель - помочь вам найти внутреннюю гармонию, разобраться с жизненными вызовами и раскрыть свой потенциал.',
